...
export default class LoginScreen extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <Image source={require("../assets/authHeader.png")} style={{position:"absolute",top:-150,left:-20,width:450,height:450}}></Image>
            ...
            style={{position:"absolute",top:100,left:110,width:190,height:190}}>
            ...
            <TouchableOpacity style={{alignSelf:"center",marginTop:32}} onPress={()=>this.props.navigation.navigate("Register")}>
                <Text style={{color:"#414959",fontSize:13}}>
                    New to MindCommute? <Text style={{fontWeight:"500",color:"#f29655"}}>Sign Up</Text>
                </Text>
            </TouchableOpacity>
            </View>
